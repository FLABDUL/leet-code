...
public class SurroundingRegionsSolution {
    public static void main(String[] args) {
        ...
        SurroundingRegionsSolution surroundingRegionsSolution = new SurroundingRegionsSolution();
        surroundingRegionsSolution.solve(board);
